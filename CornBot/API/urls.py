...
urlpatterns=[
    ...
    url(r'^getMsclfyImagAnalytics', views.get_misclasfy_image_Analytics),
    url(r'^get_user_acc_Analytics', views.get_user_acc_Analytics),
    #url(r'^getAnalytics/(?P<pk>[0-9]+)$', views.get_misclasfy_image_Analytics),
